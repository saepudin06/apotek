...
/**
* Json library
* @class Invoice_receive_controller
...
class Invoice_receive_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('payment/invoice_receive');
            $table = $ci->invoice_receive;
    ...
    function updatepayment() {
        ...
        $invoice_id = getVarClean('invoice_id','int', 0);
        ...
        try{
            ...
            oci_bind_by_name($stmt, ':i_invoice_id', $invoice_id);
    ...
    function updatepaymentref() {
        ...
        $invoice_ref = getVarClean('invoice_ref','int', 0);
        ...
        try{
            ...
            //  Bind the input parameter
            oci_bind_by_name($stmt, ':i_invoice_ref', $invoice_ref);
            oci_bind_by_name($stmt, ':i_user', $userdata['user_name']);            
            oci_bind_by_name($stmt, ':i_bu_id', $userdata['bu_id']); 
    ...
    function generate() {
        ...
        try{
            ...
            //  Bind the input parameter
            oci_bind_by_name($stmt, ':i_supplier_id', $supplier_id);
            oci_bind_by_name($stmt, ':i_user', $userdata['user_name']);            
            oci_bind_by_name($stmt, ':i_bu_id', $userdata['bu_id']); 
