...
class Stockopname_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('store/stockopname');
            $table = $ci->stockopname;
            ...
            if(!empty($i_search)) {
                $table->setCriteria("( upper(stockop_date) like upper('%".$i_search."%') OR
                                       upper(info_so_bu) like upper('%".$i_search."%')
                                     )");
            }
    ...
    function destroy() {
        ...
        try{
            ...
            oci_bind_by_name($stmt, ':i_id_stop_nm', $items); 
