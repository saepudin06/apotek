...
/**
* Json library
* @class Financeperiod_controller
...
class Financeperiod_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','finance_period_id');
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('admin/financeperiod');
            $table = $ci->financeperiod;
    ...
    function create() {
        ...
        try{
            ...
            oci_bind_by_name($stmt, ':i_finance_period_id', $items['finance_period_id']);
    ...
    function destroy() {
        ...
        try{
            ...
            //  Bind the input parameter
            oci_bind_by_name($stmt, ':i_action', $action);
            oci_bind_by_name($stmt, ':i_finance_period_id', $items);
            oci_bind_by_name($stmt, ':i_year_period_id', $null);
...
/* End of file Financeperiod_controller.php */