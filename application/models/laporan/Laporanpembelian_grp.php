...
/**
 * Laporanpembelian_grp Model
 *
 */
class Laporanpembelian_grp extends Abstract_model {
    ...
    public $selectClause    =  "period_trans  ,
                                supplier_id   ,
                                supplier_name ,
                                address       ,
                                no_telp       ,
    ...
    public $fromClause      = "VW_LIST_REPORT_DINKES_GRP";
