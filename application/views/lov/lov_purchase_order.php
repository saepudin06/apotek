    ...
    function modal_lov_purchase_order_prepare_table() {
        ...
        jQuery("#grid-table-lov_purchase_order").jqGrid({
            ...
            colModel: [
                ...
                {label: 'Invoice Num',name: 'invoice_num_ref',width: 150, align: "left",editable: false },
                {label: 'Date',name: 'po_date',width: 150, align: "left",editable: false },                
                {label: 'Amount', name: 'amount', width: 150, align: "left", editable: false, search:false, sortable:false},
            ],
            height: '100%',
            width: 750,
            viewrecords: true,
            ...
            ondblClickRow: function(rowid) {
                ...
                var invoice_num_ref = grid.jqGrid('getCell', sel_id, 'invoice_num_ref');

                modal_lov_purchase_order_set_value(purchase_order_id,invoice_num_ref);
