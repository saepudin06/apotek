...
<script>
    ...
    function modal_lov_icon_show(the_id_field) {
        modal_lov_icon_set_field_value(the_id_field);
        $("#modal_lov_icon").modal({backdrop: 'static'});
        // modal_lov_icon_prepare_table();
    }


    function modal_lov_icon_set_field_value(the_id_field) {
         $("#modal_lov_icon_id_val").val(the_id_field);         
    }

    function modal_lov_icon_set_value(the_id_val) {
