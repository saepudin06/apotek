                        ...
                        <form method="post" id="form_data">
                            ...
                            <div class="form-row">
                                <label class="form-group has-float-label col-md-6">
                                    <input class="form-control" id="package_type_id" name="package_type_id" placeholder="" autocomplete="off" readonly="" />
                                    <span>ID *</span>
                                </label>
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."product.productpackagetype_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            loadui: "disable",
            colModel: [
...
<script type="text/javascript">
    ...
    $("#form_data").on('submit', (function (e) {
        ...
        var var_url = '<?php echo WS_JQGRID."product.productpackagetype_controller/create"; ?>';
        if(package_type_id) var_url = '<?php echo WS_JQGRID."product.productpackagetype_controller/update"; ?>';
...
<script type="text/javascript">
    function searchData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."product.productpackagetype_controller/read"; ?>',
            postData: {
