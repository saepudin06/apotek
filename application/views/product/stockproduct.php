    ...
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            colModel: [
                ...
                {label: 'Barang Masuk', name: 's_in', width: 150, align: "right", editable: false, search:false, sortable:false},
                {label: 'Barang Keluar', name: 's_out', width: 150, align: "right", editable: false, search:false, sortable:false},             
                {label: 'Total', name: 'totalqty', width: 150, align: "right", editable: false, search:false, sortable:false},
