    ...
    <div class="col-12 list">
        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
            <ol class="breadcrumb pt-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Product Type Detail</li>
            </ol>
        </nav>
            ...
            <!-- <ul class="nav nav-tabs card-header-tabs ml-0 mr-0 mb-1 col-md-4" role="tablist">
                <li class="nav-item w-50 text-center">
                    <a class="nav-link active" id="tab-1" data-toggle="tab" href="javascript:;" role="tab"
                        aria-selected="true"><strong>Product Type Detail</strong></a>
                </li>
            </ul> -->
            ...
            <div class="card-body">                          
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" id="form-ui" style="display: none;">    
                        <h5 class="mb-4">Form Product Type Detail</h5>
