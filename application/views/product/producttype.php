                        ...
                        <form method="post" id="form_data">
                            ...
                            <div class="form-row">
                                <label class="form-group has-float-label col-md-6">
                                    <input class="form-control" id="product_type_id" name="product_type_id" placeholder="" autocomplete="off" readonly="" />
                                    <span>ID *</span>
                                </label>
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."product.producttype_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            loadui: "disable",
            colModel: [
        ...
        jQuery('#grid-table').jqGrid('navGrid', '#grid-pager',
            ...
            },
            {
                ...
                onClickButton: function(){ 
                    ...
                    $('#product_type_det_id').val(null).trigger('change');
                },
                position: "last",
                title: "Add",
                cursor: "pointer",
...
<script type="text/javascript">
    ...
    function setData(rowid){
        ...
        var product_type_det_id = $('#grid-table').jqGrid('getCell', rowid, 'product_type_det_id');
        var name = $('#grid-table').jqGrid('getCell', rowid, 'name');
        
        $('#product_type_id').val(rowid);
        $('#product_type_det_id').val(product_type_det_id);
        $('#product_type_det_id').trigger('change');
    ...
    $("#form_data").on('submit', (function (e) {
        ...
        data.append("product_type_det_id", $("#product_type_det_id").val());
        // console.log(data);
        var product_type_id = $('#product_type_id').val();
            
        var var_url = '<?php echo WS_JQGRID."product.producttype_controller/create"; ?>';
        if(product_type_id) var_url = '<?php echo WS_JQGRID."product.producttype_controller/update"; ?>';
...
<script type="text/javascript">
    function searchData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."product.producttype_controller/read"; ?>',
            postData: {
