...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            ...
            postData: { stock_product_id : '<?php echo $this->input->post('stock_product_id'); ?>'},
            datatype: "json",
            mtype: "POST",
            loadui: "disable",
            colModel: [
                {label: 'ID', name: 'stockproductdetails_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Stock Request ID', name: 'stock_product_id', width: 100, align: "left", editable: false, search:false, sortable:false, hidden: true},
            ...
            editurl: '<?php echo WS_JQGRID."product.stockproductdetails_controller/read"; ?>',
            caption: "Detail"
...
<script type="text/javascript">
    $("#tab-1").on("click", function(event) {
        ...
        loadContentWithParams("product.stockproduct", {});
    });
</script>
