                        ...
                        <form method="post" id="form_data" enctype="multipart/form-data" accept-charset="utf-8">
                            ...
                            <div class="form-row">
                                <label class="form-group has-float-label col-md-6">
                                    <input class="form-control" id="grn_evd_id" name="grn_evd_id" placeholder="" autocomplete="off" readonly="" />
                                    <span>ID *</span>
                                </label>
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."transaction.goods_rcv_nt_evd_controller/crud"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."transaction.goods_rcv_nt_evd_controller/crud"; ?>',
...
<script type="text/javascript">
    ...
    $("#form_data").on('submit', (function (e) {
        ...
        var var_url = '<?php echo WS_JQGRID."transaction.goods_rcv_nt_evd_controller/create"; ?>';
...
<script type="text/javascript">
    function searchData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."transaction.goods_rcv_nt_evd_controller/read"; ?>',
            postData: {
