...
<script type="text/javascript">
    $("#tab-1").on("click", function(event) {
        ...
        loadContentWithParams("admin.yearperiod", {});
    });
</script>
...
<script type="text/javascript">
    ...
    function setData(rowid){
        ...
        var year_period_id = $('#grid-table').jqGrid('getCell', rowid, 'year_period_id');
    ...
    $("#form_data").on('submit', (function (e) {
        ...
        var finance_period_id = $('#finance_period_id').val();
...
<script type="text/javascript">
    function searchData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."admin.financeperiod_controller/read"; ?>',
            postData: {
