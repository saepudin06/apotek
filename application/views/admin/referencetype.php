    ...
    <div class="col-12">        
        <div class="card mb-4">
            <ul class="nav nav-tabs card-header-tabs ml-0 mr-0 mb-1 col-md-4" role="tablist">
                ...
                <li class="nav-item w-50 text-center">
                    <a class="nav-link" id="tab-2" data-toggle="tab" href="javascript:;" role="tab" aria-selected="false"><strong>Daftar Referensi</strong></a>
                </li>
            </ul>
            ...
            <div class="card-body">            
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" id="form-ui" style="display: none;">    
                        <h5 class="mb-4">Form Tipe Referensi</h5>
                        ...
                        <form method="post" id="form_data">
                            ...
                            <div class="form-row">
                                <label class="form-group has-float-label col-md-6">
                                    <input class="form-control" id="reference_type_id" name="reference_type_id" placeholder="" autocomplete="off" readonly="" />
                                    <span>ID *</span>
                                </label>
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."admin.referencetype_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            loadui: "disable",
            colModel: [
                {label: 'ID', name: 'reference_type_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Kode', name: 'code', width: 100, align: "left", editable: false, search:false, sortable:false},
                {label: 'Tipe Referensi', name: 'name', width: 220, align: "left", editable: false, search:false, sortable:false},
            ...
            editurl: '<?php echo WS_JQGRID."admin.referencetype_controller/crud"; ?>',
            caption: "Tipe Referensi"
...
<script type="text/javascript">
    $("#tab-2").on("click", function(event) {
        ...
        var grid = $('#grid-table');
        reference_type_id = grid.jqGrid ('getGridParam', 'selrow');
        code = grid.jqGrid ('getCell', reference_type_id, 'code');
        ...
        loadContentWithParams("admin.referencelist", {
...
<script type="text/javascript">
    ...
    $("#form_data").on('submit', (function (e) {
        ...
        var reference_type_id = $('#reference_type_id').val();
            
        var var_url = '<?php echo WS_JQGRID."admin.referencetype_controller/create"; ?>';
        if(reference_type_id) var_url = '<?php echo WS_JQGRID."admin.referencetype_controller/update"; ?>';
...
<script type="text/javascript">
    function searchData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."admin.referencetype_controller/read"; ?>',
            postData: {
