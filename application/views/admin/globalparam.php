    ...
    <div class="col-12 list">
        ...
        <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
            <ol class="breadcrumb pt-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Global Param</li>
            </ol>
        </nav>
            ...
            <!-- <ul class="nav nav-tabs card-header-tabs ml-0 mr-0 mb-1 col-md-4" role="tablist">
                <li class="nav-item w-50 text-center">
                    <a class="nav-link active" id="tab-1" data-toggle="tab" href="javascript:;" role="tab"
                        aria-selected="true"><strong>Global Param</strong></a>
                </li>
            </ul> -->
            ...
            <div class="card-body">                          
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" id="form-ui" style="display: none;">    
                        <h5 class="mb-4">Form Global Param</h5>
                        ...
                        <form method="post" id="form_data">
                            ...
                            <div class="form-row">
                                <label class="form-group has-float-label col-md-6">
                                    <input class="form-control" id="global_param_id" name="global_param_id" placeholder="" autocomplete="off" readonly="" />
                                    <span>ID *</span>
                                </label>
                            ...
                            <div class="form-row">
                                <label class="form-group has-float-label col-md-6">
                                    <input class="form-control" id="value" name="value" placeholder="" autocomplete="off" autofocus="" />
                                    <span>Value *</span>
                                </label>
...
<script>
    jQuery(function($) {
        ...
        jQuery("#grid-table").jqGrid({
            url: '<?php echo WS_JQGRID."admin.globalparam_controller/crud"; ?>',
            datatype: "json",
            mtype: "POST",
            loadui: "disable",
            colModel: [
                {label: 'ID', name: 'global_param_id', key: true, width: 5, sorttype: 'number', editable: true, hidden: true},
                {label: 'Code', name: 'code', width: 100, align: "left", editable: false, search:false, sortable:false},
                {label: 'Value', name: 'value', width: 100, align: "left", editable: false, search:false, sortable:false},
            ...
            editurl: '<?php echo WS_JQGRID."admin.globalparam_controller/crud"; ?>',
...
<script type="text/javascript">
    ...
    function setData(rowid){
        ...
        var value = $('#grid-table').jqGrid('getCell', rowid, 'value');
        var description  = $('#grid-table').jqGrid('getCell', rowid, 'description');
        
        $('#global_param_id').val(rowid);
        $('#code').val(code);
        $('#value').val(value);
    ...
    $("#form_data").on('submit', (function (e) {
        ...
        var global_param_id = $('#global_param_id').val();
            
        var var_url = '<?php echo WS_JQGRID."admin.globalparam_controller/create"; ?>';
        if(global_param_id) var_url = '<?php echo WS_JQGRID."admin.globalparam_controller/update"; ?>';
...
<script type="text/javascript">
    function searchData(){
        ...
        jQuery("#grid-table").jqGrid('setGridParam',{
            url: '<?php echo WS_JQGRID."admin.globalparam_controller/read"; ?>',
            postData: {
